...
COLUMNS_TO_DROP = [
    'Unnamed: 0', 'Contact Serial Number', 'ED Checkin Dt Tm',
    'ED Checkout Dt Tm', 'MRN', 'ED Derived Disposition', 'Race Line',
    'Patient Death Ind', 'ED Room Number'
]
# demographics
